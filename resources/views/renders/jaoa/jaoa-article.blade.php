													...
													<tbody>
														<tr>
															<td style="padding: 0px 0px 20px 0px;">
																<a id="articleTitle" href="@{{ article_url }}" style="text-decoration: none; font-family: 'Raleway', Helvetica, arial, sans-serif; font-weight: 500; font-size: 22px; line-height: 28px; color: #a464c5;" class="body-text" target="_blank">@{{ title }}</a></td>
														</tr>
														<tr>
