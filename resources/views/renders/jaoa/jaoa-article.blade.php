				...
				<table border="0" cellpadding="0" cellspacing="0" width="520" class="wrapper">
					<tbody>
						<tr>
							<td>
								<!-- SECTION TITLE-->
								<table border="0" cellpadding="0" cellspacing="0" width="100%" align="center" bgcolor="#a464c5" class="wrapper">
									<tbody>
										<tr>
											<td align="center" class="section-title" style="background-color: #a464c5;">
												<table border="0" cellpadding="0" cellspacing="0" width="480" class="wrapper">
													<tbody>
														...
														<tr>
															<td style="padding: 5px 0px 6px 0px; font-family: 'Raleway', Helvetica, arial, sans-serif; font-weight: normal; font-size: 20px; line-height: 24px; text-transform: uppercase; color: #ffffff;" class="body-text">Brief Report</td>
														</tr>
													</tbody>
												</table>
											</td>
													...
													<tbody>
														<tr>
															<td style="padding: 0px 0px 20px 0px;">
																<a href="@{{ article_url }}" style="text-decoration: none; font-family: 'Raleway', Helvetica, arial, sans-serif; font-weight: 500; font-size: 22px; line-height: 28px; color: #a464c5;" class="body-text" target="_blank">@{{ title }}</a></td>
														</tr>
														<tr>
